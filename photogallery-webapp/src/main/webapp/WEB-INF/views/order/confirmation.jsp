        ...
        <table class="table table-bordered table-hover">
            ...
            <c:forEach var="item" items="${container.list}">
                <tr>
                    ...
                    <td class="text-center">${item.priceImpl.format.format}</td>
                    <td class="text-center">${item.priceImpl.paperType.paperType}</td>
                    <td class="text-center">${item.quantity}</td>
                    <td class="text-center">${item.priceImpl.priceImpl * item.quantity}</td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
